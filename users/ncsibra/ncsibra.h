...
#define COLEMAK_LAYER \
  ...
  MO(_NUM),       KC_LGUI,  OSM(MOD_LALT),  OSM(MOD_LCTL),  OSL(_LOWER),  KC_SPC,  KC_BSPC,  MO(_RAISE),  CTL_T(KC_DEL),  KC_RALT,  KC_LEAD,   KC_LEAD
...
#define QWERTY_LAYER \
  ...
  MO(_NUM),       KC_LGUI,  OSM(MOD_LALT),  OSM(MOD_LCTL),  OSL(_LOWER),  KC_SPC,  KC_BSPC,  MO(_RAISE),  CTL_T(KC_DEL),  OSM(MOD_LALT),  KC_LEAD,   KC_LEAD
