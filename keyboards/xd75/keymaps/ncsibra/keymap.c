...
static taphold_t th_events[] = { 
    ...
    { .is_pressed = false, .timer = 0, .kc_tap = KC_C,    .kc_hold = LCTL(KC_C) },
    { .is_pressed = false, .timer = 0, .kc_tap = KC_V,    .kc_hold = LCTL(KC_V) },
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QW] = {
        ...
        {MT_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_HOME, KC_DEL,  KC_PGUP, KC_H,    KC_J,    KC_K,     KC_L,    KC_SCLN, KC_ENT},
        {KC_LSFT, MT_Z,    TH_X,    TH_C,    TH_V,    KC_B,    KC_END,  KC_UP,   KC_PGDN, KC_N,    KC_M,    KC_COMM,  KC_DOT,  MT_SLSH, KC_RSFT},
        {KC_LCTL, KC_LGUI, KC_LALT, OSL(_BR),KC_SPC,  KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC, KC_ENT,  OSL(_MOV),KC_RALT, OSL(_FN),KC_RCTL},
    },
    ...
    [_BR] = {
        ...
        {_______, _______, _______, _______, _______, _______, _______, _______, _______, KC_EXLM, KC_LBRC, KC_RBRC, KC_GRV,  _______, _______},
        {_______, _______, _______, _______, KC_LSFT, KC_LSFT, _______, _______, _______, KC_MINS, KC_LPRN, KC_RPRN, KC_BSLS, KC_QUOT, _______},
        {_______, _______, _______, _______, _______, _______, _______, _______, _______, KC_EQL,  KC_ASTR, KC_AMPR, KC_CIRC, _______, _______},
        {_______, _______, _______, _______, _______, _______, _______, _______, _______, KC_AT,   KC_HASH, KC_PERC, KC_DLR, _______, _______},
    },
