...
[_QWERTY] = {
  ...
  {TT(_NUM),       KC_LGUI,  KC_LALT,  CTL_T(KC_DEL),  OSL(_LOWER),  KC_SPC,  KC_LEFT, KC_DOWN, KC_RGHT,  KC_BSPC, TT(_RAISE),  KC_RCTRL, KC_RALT,  TO(_NUM), KC_LEAD}
},
...
[_RAISE] = {
  ...
  {_______,    XXXXXXX,    XXXXXXX,       XXXXXXX,       XXXXXXX,        XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,    KC_PGUP,    XXXXXXX,    KC_PGDN,    XXXXXXX,    _______},
